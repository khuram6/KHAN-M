...
module.exports = {
    // ===== BOT CORE SETTINGS =====
    SESSION_ID: process.env.SESSION_ID || "IK~cPN1AYTR#ehw2tv8QIFlsXzVRF8b6gvckv8k1DgvwmRhi80MQu6s",  // Your bot's session ID (keep it secure)
    PREFIX: getConfig("PREFIX") || ".",  // Command prefix (e.g., "., / ! * - +")
      CHATBOT: getConfig("CHATBOT") || "on", // on/off chat bot 
    BOT_NAME: process.env.BOT_NAME || getConfig("ALI-INXIDE") || "ALI-INXIDE-MD",  // Bot's display name
    ...
    OWNER_NAME: process.env.OWNER_NAME || getConfig("ALI-INXIDE") || "Jᴀᴡᴀᴅ TᴇᴄʜX",           // Owner's name
    ...
    AUTO_STATUS_MSG: process.env.AUTO_STATUS_MSG || "*ASHU VIEWED YOUR STATUS 🤖*",  // Status reply message
    ...
    MENU_IMAGE_URL: getConfig("MENU_IMAGE_URL") || "https://files.catbox.moe/uosuez.jpg",  // Bot's "alive" menu mention image
    ...
    DESCRIPTION: process.env.DESCRIPTION || "*© ᴘᴏᴡᴇʀᴇᴅ ʙʏ Ali TᴇᴄʜX*",  // Bot description
